    ...
    return (
        <footer className="text-center">
            <p className="text-[8px] italic">
                <b className="font-bold text-[#343c6a]">DISCLAIMER: </b>
            ...
            <p className="mt-5 text-sm font-bold text-[#343c6a]">Copyright 2024. | Axiom Strategic Capital, LLC | All Rights Reserved.</p>
        </footer>
    )
}
